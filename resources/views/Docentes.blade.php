...
@section('content')
    <div class="container mt-5"style="color: #153e66;">
        ...
        <div class="row">
            <!-- Listado de docentes extraidos de la base de datos con su respectiva informacion e imagen -->
                    ...
                    <div class="card h-100 shadow overflow-hidden">
                        <div class="row g-0 h-100">
                            <div class="col-md-3 bg-light d-flex align-items-center justify-content-center">
                                @if($docente->imagen)
                                    <img src="{{asset('Imagenes/Docentes/' . $docente->imagen) }}" class="img-fluid rounded shadow-sm object-fit-cover" alt="{{ $docente->nombre }}" style="width: 100%; height: auto; max-height: 180px;">
                                @endif
                            </div>
                            <!-- Inicio de mis cards con la informacion de los docentes -->
                            <div class="col-md-8">
                                <div class="card-body">
