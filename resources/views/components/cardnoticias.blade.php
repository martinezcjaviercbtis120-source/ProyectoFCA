        ...
        <div class="carousel-inner">
            ...
            @foreach ($noticias->chunk(2) as $grupo)
                <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                    <!--variable que nos permite el funcionamiento del carrusel para los ciclos de las cards -->
                                    ...
                                    <div class="row g-0 h-100">
                                        ...
                                        <div class="col-md-5 d-flex align-items-center justify-content-center bg-white">
                                            <img src="{{ asset('Imagenes/Noticias/' . $noticia->imagen) }}"
                                                ...
                                                style="object-fit: contain; height: 380px; max-height: 220px;"
                                                alt="{{ $noticia->titulo }}">
                                        </div>
                                        ...
                                        <div class="col-md-7 bg-white">
                                            <div class="card-body d-flex flex-column justify-content-center h-100 p-3">
                                                ...
                                                <!-- Titilo del card -->
                                                <h4 class="card-title fw-bold mb-3 text-center"
                                                ...
                                                <div class="mx-auto mb-3"
                                                    style="width:70px; height:4px; background:#c69214; border-radius:10px;">
                                                </div>

                                                <!-- Descripcion -->
                                                <p class="card-text text-muted flex-grow-1 lh-lg text-justify fs-6">
                                                    {{ Str::limit($noticia->descripcion, 140) }}
                                                    <!--Nos ayuda a limitar la cantidad de texto en el card-->
                                                </p>

                                                <!-- Boton -->
                                                <div class="mt-3 text-center">
                                                    <button type="button" class="btn px-4 py-2 fw-bold"
                                                        style="background:#153e66; color:white; border-radius:10px;"
                                        ...
                                        <div class="modal-content border-0">
                                            ...
                                            <div class="modal-body p-4 text-justify">
                                                <img src="{{ asset('Imagenes/Noticias/' . $noticia->imagen) }}"
                                                    ...
                                                    alt="{{ $noticia->titulo }}">
                                                <p class="lh-lg fs-6 text-secondary" style="text-align: justify;">
                                                    {{ $noticia->noticia }}
                                                </p>
                                            </div>
